...
namespace _212410101021_Asyam_Operasi_CRUD
{
    ...
    public class DBHelperCLI
    {
        ...
        public DBHelperCLI()
        {
            while (true)
            {
                Console.WriteLine("1. Menambah Data pada Tabel");
                Console.WriteLine("2. Melihat Data pada Tabel");
                Console.WriteLine("3. Mengubah Data pada Tabel");
                Console.WriteLine("4. Menghapus Data pada Tabel");
                Console.WriteLine("99. Ingin Keluar dari Program");
                Console.WriteLine("");
                Console.Write("Masukan Angka yang ingin Anda Pilih : ");
